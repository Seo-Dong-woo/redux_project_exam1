import {
    FETCH_FOOD_DETAIL, FETCH_FOOD_LIST, FETCH_PAGE, FETCH_RECIPE_PAGE, FETCH_RECIPE_COUNT,
    FETCH_RECIPE_DETAIL, FETCH_RECIPE_LIST, FETCH_RECIPE_POSTERS, FETCH_RECIPE_MAKES, FETCH_FIND_LIST, FETCH_FIND_PAGE
} from "../actions/types";
/*
    board
    news
...
export default function (state=initialState,action){
    ...
    switch (action.type)
    {
        case FETCH_FOOD_LIST:
            return {
                ...state, // 이전에 받은 값을 초기화 하지 않고 가지고 와야 되기 때문에
